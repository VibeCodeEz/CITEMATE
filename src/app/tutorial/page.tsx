...
const steps = [
  ...
  {
    step: "4. Use DOI or URL metadata lookup when available",
    detail:
  ...
  {
    step: "5. Attach files and add tags, abstract, and subject links",
    detail:
  ...
  {
    step: "6. Review duplicate warnings before saving",
    detail:
  ...
  {
    step: "7. Generate and compare citation styles",
    detail:
  ...
  {
    step: "8. Write linked notes while the source is fresh",
    detail:
  ...
  {
    step: "9. Use search and filters to find material quickly",
    detail:
  ...
  {
    step: "10. Use AI carefully with the context controls",
    detail:
      "Before sending an AI request, review exactly which source, note, subject, reminder, or follow-up context will be included. Turn off anything you do not want to share for that request.",
  },
  {
    step: "11. Restore an earlier version if an edit goes wrong",
    detail:
  ...
  {
    step: "12. Export your workspace before major changes or deletion",
    detail:
  ...
  {
    step: "13. Manage password reset, support, and account deletion from settings",
    detail:
