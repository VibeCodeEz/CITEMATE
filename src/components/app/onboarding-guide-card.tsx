...
export function OnboardingGuideCard({ stats }: OnboardingGuideCardProps) {
  const checklistItems = [
    ...
    {
      label: "Review the final checklist",
        ...
        <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[1.75rem] border border-border/80 bg-background/80 p-5">
            ...
            <div className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
              ...
              <p>
                Once that is in place, open the citation preview, review the assistant suggestions only if needed,
                and finish with the originality checklist before submission.
              </p>
            </div>
          </div>
